...
"""
    ...
    # Add VS Code extension native-binary to PATH for Claude Agent SDK
    vs_code_bin = r"C:\Users\denis\.vscode\extensions\anthropic.claude-code-2.1.85-win32-x64\resources\native-binary"
    if vs_code_bin not in env["PATH"]:
        env["PATH"] = vs_code_bin + os.pathsep + env["PATH"]
