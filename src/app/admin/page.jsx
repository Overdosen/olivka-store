...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <div className="bg-white/80 backdrop-blur-sm p-8 rounded-md shadow-sm border border-stone-200/60 relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
        ...
        <div className="bg-white/80 backdrop-blur-sm p-6 rounded-md shadow-sm border border-stone-200/60 hover:shadow-md transition-shadow">
          <p className="text-xs uppercase tracking-wider text-stone-400 font-semibold mb-1">Всього клієнтів</p>
          <p className="text-4xl font-cormorant font-bold text-stone-800">{stats.totalClients}</p>
        </div>
        <div className="bg-white/80 backdrop-blur-sm p-6 rounded-md shadow-sm border border-stone-200/60 hover:shadow-md transition-shadow">
          <p className="text-xs uppercase tracking-wider text-stone-400 font-semibold mb-1">Нових клієнтів за тиждень</p>
          <p className="text-4xl font-cormorant font-bold text-stone-800">{stats.newClients}</p>
        </div>
        <div className="bg-white/80 backdrop-blur-sm p-6 rounded-md shadow-sm border border-stone-200/60 hover:shadow-md transition-shadow">
