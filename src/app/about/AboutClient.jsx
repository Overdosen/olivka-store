...
<strong>Післяплата з частковою передоплатою:</strong> Оплата при отриманні у відділеннях Нової Пошти або Укрпошти. У такому разі вноситься мінімальна передоплата у розмірі 200 грн. Решту суми замовлення ви сплачуєте безпосередньо при отриманні посилки.<br><br>
...
При замовленні на суму від 3000 грн доставка здійснюється за наш рахунок.<br><br>
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        padding: 'calc(5rem - 50px) 2rem calc(4rem - 30px)',
        textAlign: 'center',
