...
export default function HomeClient({ blogPosts = [] }) {
  ...
  const features = [
    ...
    },
    {
      ...
      content: "Ми обожнюємо дарувати радість, тому кожне ваше замовлення на суму від 600 грн супроводжується приємним сюрпризом. До кожної посилочки ми додаємо корисний та затишний подарунок. Для замовлень від 600 грн — це м'які шкарпетки, а для замовлень від 1900 грн — ніжний мусліновий рушничок. Для нас важливо, щоб ви відчували щиру турботу про комфорт вашого малюка з першої хвилини знайомства з нашим магазином."
    }
  ];
